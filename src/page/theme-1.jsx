...
const Theme1 = () => {
    return(
        <>
            <BackgroundSlide theme="theme3" />
            <div className="background-solid pb-5">
              <Mempelai type="00328" />
              <div className="container mt-5">
                <div className="d-flex justify-content-center align-items-center flex-column">
                  <div className="font-meow font-4 font-white">
                    Hari Bahagia
                  </div>
                  <Countdown date={'12/12/2023 10:1 AM'} class="reflection" />
                  <a href="/" className="button-savedate mt-7">
                    <i className='fal fa-calendar-alt'></i> Ingatkan di kalender
                  </a>
                </div>
              </div>
              <div className="container freeze mt-5">
                <div className="page-content ">
                  <div className="row">
                    {data.map((items) => {
                      return(
                        <div className="col-md-6 mt-2" key={items.keyId}>
                          <Card type="card-00238" data={items.data} />
                        </div>
                      )
                    })}
                  </div>
              ...
              <div className="container mt-5">
                <div className="font-dongle font-2 text-center font-white">
              ...
              <div className="container">
                  <div className="hero-page">
                      <div className="hero-page-top flex-column" style={{ alignItems:'center' }}>
                          <div className="font-meow font-white font-4 font-md-3">
                              Captured Moments
                          </div>
                      </div>
            ...
            <div className="container pb-5 pt-5">
              <div className="d-flex justify-content-center align-items-center flex-column">
                  <div className="font-meow font-4 mb-5">
                      Love Story
                  </div>
                  <TimeLine />
              </div>

...
class Theme1 extends Component {
  ...
  componentDidMount(){
      if (GetLocalStorage('editableContent') !== null) {
        this.setState({
          editable: true
        })
      }
  ...
  render(){
      return(
        <>
          <BackgroundSlide theme="theme2"/>
          <Mempelai type="00327"/>
          <div className="container-celebrate">
              <div className="bg-celebrate" style={{backgroundImage:'url(./wedding-rings.jpg)'}}>
                  <div className="celebrate-overflow">
                      <div className="content">
                        <h4>CELEBRATE OUR LOVE</h4>
                        <h5>Sabtu, 05 Desember 2022</h5>
                        <a href="/" className="button-savedate mt-3">
                          <i className='fal fa-calendar-alt'></i> Ingatkan di kalender
                        </a>
                      </div>
                  </div>
                  <div className="content-celebrate">
